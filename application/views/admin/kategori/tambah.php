...
<div class="form-group">
    ...
    <div class="col-md-5">
        <input type="text" name="nama_kategori" class="form-control" placeholder="Kategorinya" value="<?php echo set_value('nama_kategori') ?>" required>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-5">
        <input type="number" name="urutan" class="form-control" placeholder="Urutannya" value="<?php echo set_value('urutan') ?>" required>
    </div>
</div>
